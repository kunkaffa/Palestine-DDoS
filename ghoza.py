...
def countdown(t):
    ...
    while True:
        ...
        if remaining_time > 1:
            ...
            print(f"\r💥 {Fore.LIGHTBLUE_EX} {target} {Fore.BLUE}Sec left{Fore.RED} {remaining_time:.2f}")
            print(f"\r☠️ {Fore.YELLOW} {taget} {Fore.BLUE} {port}")
    ...
    async with aiohttp.ClientSession(timeout=timeout, connector=conn) as session:
        ...
        async def progress():
            while time.time() < end_ts:
                ...
                print(f"\r💥 {Fore.LIGHTBLUE_EX} {target} {Fore.BLUE}Sec left{Fore.RED} {remaining_time:.2f}")
                print(f"\r☠️ {Fore.YELLOW} {target} {Fore.BLUE} {port}")
